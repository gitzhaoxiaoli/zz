 ...
 */
define("WECHAT_URL", 'http://121.196.206.29/ap/api/lanewechat/');
define('WECHAT_TOKEN', 'weixin');
define('ENCODING_AES_KEY', "dX9eU3mui07LZzbu1NfvpNBCvk1vSDu2xhFeFUtlXD0");

/*
 * 开发者配置
 */
define("WECHAT_APPID", 'wxb600a2a15c30ce41');
define("WECHAT_APPSECRET", 'b8ae8344cee8ca1f686834d2806144f7');

...
if( !$export ){
	...
	$sql = "SELECT cert.*,e.ep_name,ct.ct_code,cti.cti_code FROM sp_certificate cert $join WHERE 1 $where and cert.iso_prod_type = 1 ORDER BY cert.id DESC $pages[limit]";

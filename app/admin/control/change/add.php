...
$proj_ls = $db->find_results("project","and cti_id='$zs_info[cti_id]' and iso='$zs_info[iso]' and deleted='0' and audit_type!='1002' AND audit_type<>'' and iso_prod_type = 0 ","id,tid,audit_type,status");
...
if($certchange_array){
	...
	foreach($certchange_array as $key=>$value){
		...
		if($key==$type)
			$checked="checked";
		if($key == '97' || $key == '97_01' || $key == '97_02' || $key == '97_03' || $key == '97_05'){

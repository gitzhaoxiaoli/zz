...
class upload {//类定义开始
    ...
    private $config =   array(
        'maxSize'           =>  102400000, // 上传文件的最大值 php.ini是52M
        // upload_max_filesize = 52M,post_max_size = 52M
        'supportMulti'      =>  true,    // 是否支持多文件上传
        'allowExts'         =>  array('jpg', 'jpeg', 'gif', 'png', 'xls', 'xlsx', 'zip', 'rar', 'doc', 'docx', 'pdf','rtf','tif'),    // 允许上传的文件后缀 留空不作后缀检查
